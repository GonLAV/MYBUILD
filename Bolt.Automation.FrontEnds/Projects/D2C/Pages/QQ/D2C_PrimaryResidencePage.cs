...
{
    public class D2C_PrimaryResidencePage(
    ...
    ) : D2CBase(browserManager, pageHelper, scopeContext, validatePageReady, logger)
    {
        ...
        protected override string PageIdentifier => "primary-residence";
        protected override string PageName => "Primary Residence Page";
        #endregion
    }
}
