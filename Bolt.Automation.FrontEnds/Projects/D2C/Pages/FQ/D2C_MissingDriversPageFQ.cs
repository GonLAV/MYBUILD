...
{
    public class D2C_MissingDriversPageFQ(
    ...
    ) : D2CBase(browserManager, pageHelper, scopeContext, validatePageReady, logger)
    {
        ...
        protected override string PageIdentifier => "-missing-drivers";
        protected override string PageName => "Missing Drivers Full Quote Page";
        #endregion
    }
}
