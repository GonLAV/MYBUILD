...
{
    public class D2C_BristolWestVehiclesFQ(
    ...
    {
        protected override string PageIdentifier => "bristol-west-vehicles";
        protected override string PageName => "Bristol West Vehicles Full Quote Page";
    }
}
