...
{
    public class D2C_BristolWestDriversFQ(
    ...
    {
        protected override string PageIdentifier => "bristol-west-drivers";
        protected override string PageName => "Bristol West Drivers Full Quote Page";
    }
}
