...
{
    public class D2C_BristolWestEsignFQ (
    ...
    {
        protected override string PageIdentifier => "bristol-west-esign-finalize";
        protected override string PageName => "bristol west esign finalize Full Quote Page";
    }
}
