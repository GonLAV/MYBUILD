...
{
    public class D2C_BristolWestPolicyFQ(
    ...
    {
        protected override string PageIdentifier => "bristol-west-policy";
        protected override string PageName => "Bristol West Policy Full Quote Page";
    }
}
