...
{
    public class D2C_PaymentSuccessPageFQ(
    ...
    ) : D2CBase(browserManager, pageHelper, scopeContext, validatePageReady, logger)
    {
        ...
        protected override string PageIdentifier => "payment-success";
        protected override string PageName => "Payment Success Full Quote Page";
        #endregion
    }
}
