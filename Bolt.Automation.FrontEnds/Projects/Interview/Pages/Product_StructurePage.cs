...
{
    public class Product_StructurePage : InterviewBase
    {
        public Product_StructurePage(
        ...
        protected override string PageIdentifier => "Structure";
        protected override string PageName => "Structure Page";
    }
}
