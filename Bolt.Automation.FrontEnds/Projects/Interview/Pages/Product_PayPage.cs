...
{
    public class Product_PayPage : InterviewBase
    {
        public Product_PayPage(
        ...
        protected override string PageIdentifier => "_Pay";
        protected override string PageName => "Payment Page";
    }
}
