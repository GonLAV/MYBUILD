...
{
    public class Product_FeaturesPage : InterviewBase
    {
        public Product_FeaturesPage(
        ...
        protected override string PageIdentifier => "HomeFeatures";
        protected override string PageName => "Features Page";
    }
}
