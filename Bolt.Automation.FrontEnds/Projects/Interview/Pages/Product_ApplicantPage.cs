...
{
    public class Product_ApplicantPage : InterviewBase
    {
        public Product_ApplicantPage(
        ...
        protected override string PageIdentifier => "_Applicant";
        protected override string PageName => "Applicant Page";
    }
}
