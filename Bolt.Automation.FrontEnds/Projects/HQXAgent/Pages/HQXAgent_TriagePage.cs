...
{
    public class HQXAgent_TriagePage(IBrowserManager browserManager,
    ...
    {
        protected override string PageIdentifier => "Triage";
        protected override string PageName => "PGR Triage Page";

        protected override Dictionary<string, UIElement> FieldRegistry => TriageFields.Fields;
