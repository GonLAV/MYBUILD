...
{
    public class HQXAgent_ExteriorPage(IBrowserManager browserManager,
    ...
    {
        protected override string PageIdentifier => "Exterior";
        protected override string PageName => "PGR Exterior Page";

        protected override Dictionary<string, UIElement> FieldRegistry => ExteriorFields.Fields;
