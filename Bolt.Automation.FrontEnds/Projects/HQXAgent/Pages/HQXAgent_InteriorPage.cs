...
{
    public class HQXAgent_InteriorPage(IBrowserManager browserManager,
        ...
        : HQXAgentBase(browserManager, pageHelper, scopeContext, validatePageReady, logger)
    {
        ...
        protected override string PageName => "PGR Interior Page";

        protected override Dictionary<string, UIElement> FieldRegistry => InteriorFields.Fields;
