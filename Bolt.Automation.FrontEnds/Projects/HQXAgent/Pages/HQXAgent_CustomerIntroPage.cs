...
{
    public class HQXAgent_CustomerIntroPage(IBrowserManager browserManager,
    ...
    {
        protected override string PageIdentifier => "Intro";
        protected override string PageName => "PGR Customer Intro Page";
