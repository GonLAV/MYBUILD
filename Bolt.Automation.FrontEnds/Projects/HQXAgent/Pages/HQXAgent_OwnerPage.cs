...
{
    public class HQXAgent_OwnerPage(IBrowserManager browserManager,
        ...
        : HQXAgentBase(browserManager, pageHelper, scopeContext, validatePageReady, logger)
    {
        ...
        protected override string PageName => "PGR Owner Page";

        protected override Dictionary<string, UIElement> FieldRegistry => OwnerFields.Fields;
