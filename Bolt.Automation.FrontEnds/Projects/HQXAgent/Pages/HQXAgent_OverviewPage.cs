...
{
    public class HQXAgent_OverviewPage(IBrowserManager browserManager,
        ...
        : HQXAgentBase(browserManager, pageHelper, scopeContext, validatePageReady, logger)
    {
        ...
        protected override string PageName => "PGR Overview Page";

        protected override Dictionary<string, UIElement> FieldRegistry => OverviewFields.Fields;
